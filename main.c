...
/*In a small team, design and implement Blackjack card game. You can implement one player version against computer (dealer), or multiplayer version between human players. Design details and applied rules are on you. Simulating card decks is not required.
*/